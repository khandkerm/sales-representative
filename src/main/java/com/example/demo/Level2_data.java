...
public class Level2_data {
	...
	public Level2_data(String iTEM_CODE, String iTEM_DESCR, String sTATUS, String pARENT_ITEM_ID, String cAT_CODE) {
		super();
		ITEM_CODE = iTEM_CODE;
	...
	public String toString() {
		return "Level2_data [ITEM_CODE=" + ITEM_CODE + ", ITEM_DESCR=" + ITEM_DESCR + ", STATUS=" + STATUS
