...
public class Level2 {
	...
	public Level2(String cAT_CODE, String iTEM_CODE, String iTEM_DESCR, String sTATUS, String pARENT_ITEM_ID,
			String cAT_DESCR) {
		super();
		CAT_CODE = cAT_CODE;
		ITEM_CODE = iTEM_CODE;
	...
	public String toString() {
		return "Level2 [CAT_CODE=" + CAT_CODE + ", ITEM_CODE=" + ITEM_CODE + ", ITEM_DESCR=" + ITEM_DESCR + ", STATUS="
				+ STATUS + ", PARENT_ITEM_ID=" + PARENT_ITEM_ID + ", CAT_DESCR=" + CAT_DESCR + "]";
	}
