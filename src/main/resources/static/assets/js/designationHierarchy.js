function addDesignation() {
	...
	var container = document.getElementById("designation");
	var valM = "";
	...
	button.onclick = function printValues() {
		...
		var urlString = "http://localhost:8089//designation_Hy/" + valM;
		...
		$.ajax({
			...
			.done(function(responseJson) {
				...
				window.location.href = "http://localhost:8089/designationHierarchy";
			})
			.fail(function() {
